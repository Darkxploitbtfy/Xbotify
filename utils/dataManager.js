...
// Toggles (antidelete, antiedit, anticall, alwaysonline) survive bot restarts.
// File: data/state-{safeKey}.json
...
function loadSessionState(phoneOrId) {
  return r(_stateFile(phoneOrId), { anticall: false, antidelete: false, antiedit: false, alwaysonline: false });
}
